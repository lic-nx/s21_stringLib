...
char *s21_strrchr(const char *src, int c);                          //  17
s21_size_t s21_strspn(const char *str1, const char *str2);          //  18
char *s21_strstr(const char *str1, const char *str2);               //  19
...
char *s21_format_param_to_str(char *str, s21_size_t *str_len, FORMAT *FFormat,
                              va_list *argList);
char *s21_itoa(const char *format, int *number, va_list *argList);
...
char *s21_ftoa(char *str, long double number, FORMAT *FFormat);
